...
const CommonSales = () => {
  return (
    <div className="flex 2xl:flex-col xl:flex-col  h-fit w-fit  gap-3 rounded-2xl 
    text:black dark:text-white text-lg bg-neutral-300 dark:bg-darkbg animate-fadeup">
      {/* Top Section */}
      <div>
