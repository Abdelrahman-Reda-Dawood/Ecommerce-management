...
const OrderCard = ({
  ...
  return (
    <div className="2xl:w-[900px] w-fit h-fit p-5 my-5 rounded-lg bg-neutral-300 dark:bg-darkbg text-black dark:text-white text-2xl">
        ...
        {image ? (
          <div className="flex my-2">
            <img
              src={cardImage}
              alt="product"
              className="w-40 h-40 border border-gray-700 rounded-lg"
            />
            <div className="p-3">
              PRODUCT_NAME
              ...
              <div className="flex text-sm space-x-5 mt-5 items-center">
                ...
                <div
                  className={`bg-yellow-300 w-5 h-5 border rounded-full`}
                />
              </div>
            </div>
          </div>
