...
function Checkout() {
  return (
    <div className=" flex justify-end px-4 sm:px-6 lg:px-8 animate-fadeup">
      <div className="mt-8 max-w-sm md:mt-12">
        <div className="bg-stone-200 dark:bg-darkbg text-black dark:text-white rounded-3xl">
          <div className="flex flex-col justify-around px-4 py-6 sm:px-8 sm:py-10">
            {/* Product Details */}
            <ul className="-my-8">
              <li className="flex flex-col space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                ...
                <div class="relative flex flex-1 flex-col justify-between">
                  ...
                  <div class="absolute top-0 right-0 flex sm:bottom-0 sm:top-auto">
                    <button class="flex rounded p-2 text-center  transition-all duration-200 ease-in-out focus:shadow hover:text-gray-900">
                      <svg
                        class="h-5 w-5"
            ...
            <div class="mt-6 text-center">
              <button class="group flex w-full items-center justify-center rounded-md bg-green-500 px-6 py-4 text-lg font-semibold text-white focus:shadow hover:bg-primarygreen">
                Place Order
                <svg
                  xmlns="http://www.w3.org/2000/svg"
